// Package errgroup набор горутин для запуска подзадач некоторой большой задачи
// с возможностью обработки ошибок каждой из подзадач
package errgroup
...
// использования кейса прерывания по ошибке и набор ошибок объединенных в `errors.List` с
